            ...
            item {
                Card(
                    ...
                    Column(modifier = Modifier.padding(18.dp)) {
                        ...
                        Text(
                            text = "• Alarms are scheduled with Android AlarmClock precision.\n• When your phone restarts, MedTime automatically restores all reminders.\n• For highest reliability on some devices (Xiaomi, Samsung, Huawei), disable battery optimization for MedTime in system settings so background timers aren't delayed.",
                            style = MaterialTheme.typography.bodySmall,
                            color = MaterialTheme.colorScheme.onSurfaceVariant,
                            lineHeight = 18.sp
                        )
