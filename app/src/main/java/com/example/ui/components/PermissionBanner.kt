...
fun PermissionBanner(
    ...
    val prefs = remember { context.getSharedPreferences("medtime_prefs", Context.MODE_PRIVATE) }
    val autostartDismissed = remember {
        androidx.compose.runtime.mutableStateOf(
            prefs.getBoolean("autostart_dismissed", false)
        )
    }

    val showAutostart = hasAutostartSetting && !autostartDismissed.value
                ...
                if (showAutostart) {
                    ...
                    Button(
                        onClick = {
                            ...
                            prefs.edit().putBoolean("autostart_dismissed", true).apply()
